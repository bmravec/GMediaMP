...
TagHandler *tag_handler_new ();
GType tag_handler_get_type (void);

gboolean tag_handler_activate (TagHandler *self);
gboolean tag_handler_deactivate (TagHandler *self);

void tag_handler_add_entry (TagHandler *self, const gchar *location);
